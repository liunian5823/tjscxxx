          ...
          <ul class="infinite-list" style="overflow: auto">
            ...
            >
              ...
              <img
                ...
                @click="xuanzeyi(index)"
              />
              <span @click="diyi(index)">{{ as.name }}</span>
            </li>
          </ul>
        </el-col>
          ...
          <ul class="infinite-list" style="overflow: auto">
            ...
            >
              ...
              <img
                ...
                @click="xuanzeer(index)"
              />
              <span @click="dier(index)">{{ bs.name }}</span>
            </li>
          </ul>
        </el-col>
...
export default {
  ...
  methods: {
            ...
            for (var o = 0; o < a[i].isopt.length; o++) {
              ...
              for (var p = 0; p < a[i].isopt[o].isopt.length; p++) {
                if (a[i].isopt[o].isopt[p].ifSelect == "false") {
                  ...
                  a[i].isopt[o].isopt[p].iconShow = "1";
                }
              }
            }
          }
    ...
    xuanzesan(e) {
      if (this.a[this.diers].isopt[this.disan].isopt[e].iconShow == "1") {
        ...
        this.a[this.diers].isopt[this.disan].isopt[e].iconShow = "1";
      ...
      for (
        ...
        if (this.a[this.diers].isopt[this.disan].isopt[i].iconShow == "1") {
          csd++;
        }
      }
      //console.log(csd);
    ...
    xuanzeer(e) {
      if (this.a[this.diers].isopt[e].iconShow == "2") {
        ...
        for (var i = 0; i < this.a[this.diers].isopt[e].isopt.length; i++) {
          this.a[this.diers].isopt[e].isopt[i].iconShow = "1";
    ...
    xuanzeyi(e) {
      if (this.a[e].iconShow == "2") {
        ...
        for (var o = 0; o < this.a[e].isopt.length; o++) {
          ...
          for (var p = 0; p < this.a[e].isopt[o].isopt.length; p++) {
            this.a[e].isopt[o].isopt[p].iconShow = "1";
