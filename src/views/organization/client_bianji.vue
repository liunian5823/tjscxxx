<template>
  <div>
    <div v-if="Employees == '1'">
      <Employees :project="xiangqing" @close="close" />
    </div>
    ...
    <div class="bgBorderTwo">
      ...
      <div class="el-detail el-detail-1">
        ...
        <div class="el-detail-item el-clearfix">
          ...
          <div class="tCon">
            {{ xiangqing.entrustUser }} {{ xiangqing.entrustUserPhone }}
          </div>
        </div>
        <div class="el-detail-item el-clearfix">
    ...
    <div class="bgBorderThree">
      <div class="el-b">
        <el-button class="el-noColor" @click="back">返回</el-button>
...
export default {
  ...
  //   /system/jp-entrust/searchUserPageList/{page}/{size}
  mounted() {
  ...
  methods: {
    huoquxiangqing() {
      ...
      this.httpsapi
        ...
        .then(response => {
          ...
          this.value =
            response.data.projectPerson +
            response.data.projectPersonPhone +
            "【" +
            response.data.adminUserId +
            "】";
        })
        .catch(err => {
          //console.log(err);
    ...
    baocun() {
      ...
      if (typeof this.value == "number") {
        ...
        console.log("123");
        var obj = {
          id: this.ecOrganizationId,
          projectPerson: this.options[this.value].realName,
          projectPersonPhone: this.options[this.value].phone,
          adminUserId: this.options[this.value].id,
          remarks: this.textarea
        };
      } else {
        var obj = {
          id: this.ecOrganizationId,
          projectPerson: this.xiangqing.projectPerson,
          projectPersonPhone: this.xiangqing.projectPersonPhone,
          adminUserId: this.xiangqing.adminUserId,
          remarks: this.textarea
        };
      }
