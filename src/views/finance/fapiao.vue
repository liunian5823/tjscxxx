    ...
    <el-dialog v-model="dialogVisible" width="60%" :before-close="handleClose">
      <div class="invoicMain">
        <div class="invoiceHeader">
          <ul class="headerLeft">
            <li></li>
            <li><label>机器编号：</label><span></span></li>
          </ul>
          ...
          <ul class="headerRight">
            ...
            <li>
              <label> 发票号码： </label><span>{{ shujus.invNo }}</span>
            </li>
            <li>
              <label> 开票日期： </label><span>{{ shujus.createTime }}</span>
            </li>
            <!-- <li>
              <label> 校&nbsp;&nbsp;验&nbsp;&nbsp;码： </label
              ><span>111111</span>
        ...
        <div class="invoiceBody">
          <div class="userInfo">
            ...
            <ul>
              ...
              <li>
                <label>纳税人识别号：</label
                ><span>{{ shujus.taxpayerNumber }}</span>
              </li>
              <li>
                <label>地址、&nbsp;&nbsp;&nbsp;电话：</label><span>11111</span>
              </li>
              <li><label>开户行及账号：</label><span>11111</span></li>
            </ul>
            ...
            <div class="userInfo">
              ...
              <ul>
                <li>
                  <label
                    >名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：</label
                  ><span>{{ shujus.createUserName }}</span>
                </li>
                <li>
                  <label>纳税人识别号：</label
                  ><span>{{ shujus.supplierTaxpayerNumber }}</span>
                </li>
                <li>
                  <label>地址、&nbsp;&nbsp;&nbsp;电话：</label
                  ><span>11111</span>
              ...
              <div class="pwdInfo">{{ shujus.remarks }}</div>
            </div>
          </div>
          <!-- <ul class="goodsInfo">
                <li>
        ...
        <ul class="invoicetFooter">
          <li>
            <label>收款人：{{ shujus.supplierTaxpayerName }}</label>
          </li>
          <li>
            <label>复核：</label>
          </li>
          <li>
            <label>开票人：{{ shujus.createUserName }}</label>
          </li>
          <li>
            <label>销售方：（章）</label>
          </li>
...
export default {
  ...
  watch: {
    dialogVisibles: function(newval, oldval) {
      console.log(newval);
