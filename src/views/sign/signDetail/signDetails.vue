    ...
    <div class="bgBorderTwo">
      ...
      <div class="el-detail el-detail-1" :span="12">
        <div class="el-detail-item el-clearfix">
          ...
          <div class="tCon">{{ singlist.businessLicense }}</div>
        </div>
        <div class="el-detail-item el-clearfix">
...
export default {
  ...
  mounted() {
     console.log(this.$store.state.singlist.enterpriseId)
    // var a = [];
    var b = {};
  ...
  methods: {
    ...
    huoqulist() {
      // /system/jp-entrust-subject/searchEnterpriseList/{page}/{size}
        ...
        this.size;
      var obj = {
        enterpriseId:this.$store.state.singlist.enterpriseId,
       orderNum:"3"
      };
      this.httpsapi
        .POST(url, obj)
    ...
    operationsss(e) {
      e["eid"] = this.$store.state.singlists.eid;
      e["sid"] = this.$store.state.singlists.enterpriseId;
      console.log(e);
      this.$store.commit("singlistss", e);
      this.$router.push({ name: "signDetailss" });
    },
