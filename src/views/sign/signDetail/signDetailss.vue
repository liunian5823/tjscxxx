    ...
    <div class="bgBorderTwo">
      ...
      <div class="el-detail el-detail-1" :span="12">
        <div class="el-detail-item el-clearfix">
          <label class="el-pull-left"><span>项目部ID</span>：</label>
          <div class="tCon">{{ singlist.projectId }}</div>
        </div>
        <div class="el-detail-item el-clearfix">
          <label class="el-pull-left"><span>标的名称</span>：</label>
          <div class="tCon">{{ singlist.name }}</div>
        </div>
        <div class="el-detail-item el-clearfix">
        ...
        <div class="el-detail-item el-clearfix">
          <label class="el-pull-left"><span>标的类别</span>：</label>
      ...
      <div style="width: 50%">
        <el-table :data="tableData" style="width: 100%">
          <el-table-column prop="orderNum" label="委托订单数" width="180">
          </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      operationW: "180",
      // 表格操作数组
      ioperationList: { 待处置: [{ name: "查看详情" }],处置中: [{ name: "查看详情" }],已完成: [{ name: "查看详情" }],已中止: [{ name: "查看详情" }]},
      // 操作块儿是否显示
      isoperation: true,
      // 数据数组
      Dataorigin: [],
      // 表头数组
      header: [
        { name: "委托订单编号", prop: "workOrderNum" },
        { name: "订单状态", prop: "status" },
  ...
  mounted() {
    console.log(this.$store.state.singlistss);
    // var a = [];
    ...
    b["disposalQuantity"] = this.$store.state.singlist.disposalQuantity;
    b[
      "disposalUnderQuantity"
    ] = this.$store.state.singlist.disposalUnderQuantity;
  ...
  methods: {
    ...
    huoqulist() {
      ...
      var url =
        ...
        this.size;
      var obj = {
        projectId: this.$store.state.singlist.projectId,
        orderNum: "4",
      };
      this.httpsapi
        .POST(url, obj)
    ...
    operationsss(e) {
      ...
      this.$router.push({ name: "orderPa", query: { id: e.entrustOrderId } });
    },
